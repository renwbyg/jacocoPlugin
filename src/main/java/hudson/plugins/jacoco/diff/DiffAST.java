...
// *
// *******************************************************************************/
//package hudson.plugins.jacoco.diff;
//
...
//
//
//	public static void diffBaseDir(String filePath,final String baseDir) {// src1是整个工程中有变更的文件,src2是历史版本全量文件,都是相对路径,例如在当前工作空间下生成tag1和tag2
//		list = new ArrayList<File>();
//		final String tag1Path = filePath;
//		final String tag2Path = baseDir;
//		final List<File> files1 = getFileList(tag1Path,tag2Path);
...
//	 * @param ofile
//	 */
//	public static void diffFile(final String nfile,
//			final String ofile) {
...
//				JacocoPublisher.methodInfos.add(methodInfo);
//			}
//		} else {
...
//	 * @return
//	 */
//	public static List<File> getFileList(final String src,final String path) {
...
//						continue;
//					}
//					getFileList(files[i].getAbsolutePath(),path);
